$(document).ready(function(){
	...
	function createGallery(galleryId, currentSlideIndex){
		...
		$('a[data-target="'+ galleryId +'"]').each(function(){
			var img = $(this).html();  //i hap fotot
			// var galleryItem = $('<div class="item">'+ img +'</div>'); Pa linqe
			// var galleryItem = $('<div class="item"><a href="projekti.html">'+ img +'</a></div>'); nje Link per krejt fotot
